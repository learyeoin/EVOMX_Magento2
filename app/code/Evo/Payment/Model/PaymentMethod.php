...
use Evo\Payment\Model\Config\Source\Brand;
use Evo\sdk\Configurable;
use Evo\sdk\RequestFactory;
use Evo\Payment\Helper\Helper;
use Evo\Payment\Model\Config\Source\NewOrderPaymentActions;
...
class PaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod implements GatewayInterface
{
    ...
    public function getCheckoutRedirectUrl()
    {
       ...
       if ($displayMode === DisplayMode::DISPLAY_MODE_IFRAME) {
           $redirectUrl = 'evo/hosted/iframe';
        } else {
            $redirectUrl = 'evo/hosted/redirect';
        }
